# -*- coding: utf-8 -*-
"""
Created on Mon Jan  9 08:51:41 2023
...
def aux_level_random_butterfly(door_trees_list = [[i for i in range(2**n_switches)] for j in range(n_doors)],
                               exit_number=None):
...
def level_random_butterfly():
    # return aux_level_random_butterfly()
    return Maze.get_random_level_from_file(aux_level_random_butterfly)