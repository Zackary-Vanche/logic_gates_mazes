...
def level_sign(fast_solution_finding=False):
    ...
    if fast_solution_finding:
        ...
        def tree_list(n):
            return ['DIFF'] + [Tree.tree_list_BIN(4)]*(n+1)

        def Slist_n(n):
            return Slisttree[:4*n+4]

        T0 = Tree(tree_list=tree_list(0),
                  empty=True,
                  name='T0',
                  switches=Slist_n(0),
                  cut_expression=True)
        ...
        T14 = Tree(tree_list=['AND',
                   ...
                   empty=True,
                   name='T14',
                   switches=Slist_n(15) + Slist + [89, 24],
                   cut_expression=True)
        ...
        level = Maze(start_room_index=0,
                     ...
                     fastest_solution='S2 S3 S5 S7 S8 S9 S10 S11 S13 S14 S16 S17 S18 S21 S22 S23 D0',
                     level_color=Levels_colors_list.FROM_HUE(hu=0.15, sa=1, li=0.9),
                     name='Sign',
                     door_window_size=1300,
        ...
        T0 = Tree(tree_list=['DIFF'] + [Tree.tree_list_BIN(4)]*16,
                  empty=True,
                  name='T0',
                  switches=Slisttree,
                  cut_expression=True)
        ...
        level = Maze(start_room_index=0,
                     ...
                     doors_list=[D0],
                     fastest_solution='S2 S3 S5 S7 S8 S9 S10 S11 S13 S14 S16 S17 S18 S21 S22 S23 D0',
                     level_color=Levels_colors_list.FROM_HUE(hu=0.20, sa=1, li=0.9),
                     name='Sign',
