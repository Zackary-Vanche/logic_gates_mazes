...
#     for i in range(2**n):
#         for j in range(i + 1):
#             Slist0.extend([lint[j] + lint[i] * 2**n])
#     # Slist0 = sorted(Slist0)
#
#     T0 = Tree(tree_list=['IN', Tree.tree_list_BIN(2*n)] + [[None]] * len(Slist0),
#               empty=True,
#               name='T0',
#               switches=Slist + Slist0,
#               cut_expression=True)
#     T1 = Tree(tree_list=['EQU', Tree.tree_list_BIN(2*n), [None]],
#               empty=True,
#               name='T1',
#               switches=Slist + [Slist0[-1]])
#
