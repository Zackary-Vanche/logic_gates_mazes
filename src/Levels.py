                   ...
                   [lvls.level_move,
                    ...
                    [lvls.level_sapling,
                     ...
                     mkc(lvls.level_domination_number,
                         lvls.level_repetition,
                         [lvls.level_matching,
                          [lvls.level_chromatic,
                           [lvls.level_leaves,
                              mkc(lvls.level_utility_graph_2_coloring,
                                  lvls.level_rhombic_dodecahedral_graph_2_coloring,
                                  lvls.level_branches),
                              mkc(lvls.level_tree_skin,
                          ...
                          [lvls.level_shared,
                           ...
                           mkc(lvls.level_spy,
                               mkc(lvls.level_fish_graph_dominating_set,
                                   ...
                                   mkc(lvls.level_random_dominating_set,
                                       lvls.level_domatic_number),),
                               mkc(lvls.level_hitting_set,
                                   lvls.level_independent_set),
                               ),
                           mkc(lvls.level_friendship_graph_F1_adjacency_matrix,
                               lvls.level_friendship_graph_F2_adjacency_matrix,
                               lvls.level_friendship_graph_F3_adjacency_matrix),
                ...
                mkc(lvls.level_extrema,
                    ...
                    [lvls.level_inverse_permutation,
                        ...
                        mkc(lvls.level_transformation_12_13,
                         ...
                         mkc(lvls.level_order_of_a_permutation,
...
def test_levels(test_random_levels=False, check_color_contrasts=True):
    ...
    for maze in all_mazes_list:
        ...
        t0 = time()
        n_test = 0
        while time() - t0 < 20 and n_test < 10:
            t1 = time()
