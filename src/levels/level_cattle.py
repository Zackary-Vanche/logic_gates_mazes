...
def level_cattle():
    ...
    R0 = Room(name='R0',
                ...
                switches_list=[])
    R1 = Room(name='R1',
                position=[5*dx, 0*dy, dx+ex, ey],
                switches_list=Slist0)
    R2 = Room(name='R2',
                position=[2*dx, 1*dy, dx+ex, ey],
    ...
    level = Maze(start_room_index=0,
                 ...
                 fastest_solution="D0 D1 S2 D2 D0 S0 D1 S2 D3 D4 S7 D5 D0 S0 D1 S2 D2 D0 S0 D1 S2 D3 S5 D4 S6 S7 D6 D7 S10 S11 D8 D0 S0 D1 S2 D2 D9",
                 level_color=lcolor,
                 name='Cattle',
