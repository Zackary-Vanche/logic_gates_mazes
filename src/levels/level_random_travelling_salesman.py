...
def f(): 
    ...
    tree_list_SUM = ['SUM'] + [tree_list_DIST] * 5
    ...
    level = Maze(start_room_index=0,
                 ...
                 name='Random travelling salesman',
...
def get_color():
    ...
    lcolor.surrounding_color = Color.color_hls(hu=0.025, sa=1, li=0.6)
    lcolor.contour_color = Color.color_hls(hu=0.025, sa=1, li=0.6)
    return lcolor