...
def level_trail(fast_solution_finding=False): 
    ...
    T14 = Tree(tree_list=['AND',
                          ...
                          ['SUP', Tree.tree_list_BIN(2), Tree.tree_list_BIN(2)]
                          ],
                name='T14',
    ...
    level = Maze(start_room_index=0,
                 ...
                 fastest_solution="S0 D0 S4 S7 S8 S9 S10 S11 D1 D2 D5 D6 D7 D11 D13 D12 D8 D14",
                 level_color=Levels_colors_list.FROM_HUE(hu=1/2, sa=0.3, li=0.5),
                 name='Trail',
