...
def f(fast_solution_finding=False): 
    ...
    level = Maze(start_room_index=0,
                 ...
                 fastest_solution="S2 S3 S4 S5 D0 S10 D5 S8 D2 S6 D1 S7 D3 S9 D6 S11 D6 D3 D1 D2 D5 D8",
...
def get_color():
    lcolor = Levels_colors_list.FROM_HUE(hu=0.45, sa=0.4, li=0.6)
