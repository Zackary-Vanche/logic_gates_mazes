...
def f(): 
    ...
    V36 = Tree(tree_list=["DIFF", Tree.tree_list_SUM(10), [None]],
          name='V36',
          switches=[V5, V6,
                    V7, V8,
                    V9, V10,
    ...
    T9 = Tree(tree_list=["AND",
                         ...
                         [None]],
                name='T9',
                switches=[V13, V14, 5]+V_edges_list+V_edges_list[:5]+[V36],
                cut_expression_depth_1=True)
    ...
    level = Maze(start_room_index=0,
                 ...
                 fastest_solution="S0 D0 S4 D1 S6 S7 D2 D3 S14 D4 S18 D5 S25 D6 S32 D7 S34 S36 S37 D8 S40 S44 D9",
