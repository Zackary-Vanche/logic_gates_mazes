...
def get_color():
    lcolor = Levels_colors_list.FROM_HUE(hu=0.15, sa=0.8, li=0.51)
    lcolor.contour_color = Color.color_hls(hu=0, sa=1, li=0.7)
    lcolor.surrounding_color = Color.color_hls(hu=0, sa=1, li=0.7)
    return lcolor