...
def get_color():
    lcolor = Levels_colors_list.FROM_HUE(hu=0.6, sa=0.55, li=0.5)
    lcolor.surrounding_color = Color.color_hls(hu=0.6, sa=0.8, li=0.9)
    lcolor.contour_color = Color.color_hls(hu=0.6, sa=0.8, li=0.9)
    return lcolor