...
def f(): 
    ...
    T0 = Tree(tree_list=Tree.tree_list_EQUSET(4*2),
                name='T0',
                switches=[V4, V5, V6, V7, 1, 2, 3, 4])
    ...
    level = Maze(start_room_index=0,
                 ...
                 rooms_list=[R0, RE],
                 doors_list=[D0],
                 fastest_solution="S0 S4 S11 D0",
                 level_color=get_color(),
                 name='Graceful square',
...
def get_color():
    color=Color.color_hls(hu=0.75, li=0.7, sa=0.8)
    lcolor=Levels_colors_list.FROM_HUE(hu=0.75, sa=0.2, li=0.3)
