# -*- coding: utf-8 -*-
"""
Created on Mon Jan  9 22:47:26 2023
...
def aux_level_random_ladder(door_trees_list = [[i for i in range(2**n_switches)] for j in range(11)],
                            exit_number=None):
    ...
    D0 = Door(two_way=False,
              ...
              relative_departure_coordinates=rpos1,
              relative_arrival_coordinates=rpos1)
    ...
    D5 = Door(two_way=False,
              ...
              room_arrival=R4,
              relative_position=rp,
              relative_departure_coordinates=rpos2,
              relative_arrival_coordinates=rpos2)
...
def level_random_ladder():
    # return aux_level_random_ladder()
    return Maze.get_random_level_from_file(aux_level_random_ladder)