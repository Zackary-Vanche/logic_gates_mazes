...
def f(): 
    ...
    T0 = Tree(tree_list=['EQUSET'] + [[None]]*6,
                name='T0',
    ...
    T4 = Tree(tree_list=tree_list_4,
                name='T4',
                switches=[V0, 1, V1, 2, V2, 3])
    T5 = Tree(tree_list=tree_list_4,
                name='T5',
                switches=[V0, 1, V1, 3, V2, 2])
    T6 = Tree(tree_list=tree_list_4,
                name='T6',
                switches=[V0, 2, V1, 1, V2, 3])
    T7 = Tree(tree_list=tree_list_4,
                name='T7',
                switches=[V0, 2, V1, 3, V2, 1])
    T8 = Tree(tree_list=tree_list_4,
                name='T8',
                switches=[V0, 3, V1, 1, V2, 2])
    T9 = Tree(tree_list=tree_list_4,
                name='T9',
                switches=[V0, 3, V1, 2, V2, 1])
    T10 = Tree(tree_list=Tree.tree_list_from_str('FTFFTTTTTTTTT'),
                name='T10',
                switches=Slist)
    ...
    level = Maze(start_room_index=0,
                 ...
                 fastest_solution="S0 D0 D2 S3 D2 D3 S5 D3 D0 S0 D5 S8 D5 D0 D1 S2 D1 D2 S4 D2 D0 S0 D8 S11 D8 D0 D2 S3 S4 D2 D3 S5 S6 D3 D0 S0 D9 S12 D9 D0 D1 S1 D1 D2 S3 D2 D0 S0 D7 S10 D7 D0 D2 S4 D2 D3 S6 D3 D0 S0 D6 S9 D6 D0 D1 S1 S2 D1 D2 S3 S4 D2 D0 D4 S7 D4 D10",
...
get_color = lambda : Levels_colors_list.different_hues(hu_index=10, inverse_hues=True)