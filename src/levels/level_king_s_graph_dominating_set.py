...
def f(): 
    ...
    level = Maze(start_room_index=0,
                 ...
                 rooms_list=[R0, RE],
                 doors_list=[D0],
                 fastest_solution="S7 S10 S25 S28 D0",
                 level_color=get_color(),
                 name="King's graph dominating set",
...
def get_color():
    lcolor = Levels_colors_list.FROM_HUE(hu=0.2, sa=0.35, li=0.15)
    lcolor.surroungind_color = Color.color_hls(hu=0.2, sa=1, li=0.7)
