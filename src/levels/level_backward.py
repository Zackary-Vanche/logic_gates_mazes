...
def get_color():
    lcolor = Levels_colors_list.FROM_HUE(hu=0.16, sa=0.5, li=0.2)
    lcolor.surrounding_color = Color.color_hls(hu=0.12, sa=1, li=0.8)
    lcolor.contour_color = Color.color_hls(hu=0.12, sa=1, li=0.8)
    return lcolor