...
def level_octahedral_graph():
    ...
    assert len(EQUSET_list) == len(set(EQUSET_list))
    EQUSET_list.sort()
    ...
    level = Maze(start_room_index=0,
                 ...
                 rooms_list=Rl,
                 doors_list=Dl,
                 fastest_solution="S3 S7 D0 S12 S13 S17 D1 S19 S21 S22 S24 S26 D2 S27 S32 S33 S35 D3",
                 level_color=Levels_colors_list.FROM_HUE(hu=0.9, sa=0.1, li=0.5),
                 name='Octahedral graph',
