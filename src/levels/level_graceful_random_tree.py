...
def f(): 
    ...
    V15 = Tree(tree_list=tree_list_minus,
          name='V15',
          switches=[rd_choice(Vl[:2]), V9]*2)
    V16 = Tree(tree_list=tree_list_minus,
          name='V16',
          switches=[rd_choice(Vl[:3]), V10]*2)
    V17 = Tree(tree_list=tree_list_minus,
          name='V17',
          switches=[rd_choice(Vl[:4]), V11]*2)
    V18 = Tree(tree_list=tree_list_minus,
          name='V18',
          switches=[rd_choice(Vl[:5]), V12]*2)
    V19 = Tree(tree_list=tree_list_minus,
          name='V19',
          switches=[rd_choice(Vl[:6]), V13]*2)
