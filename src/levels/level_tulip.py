...
def f(): 
    ...
    T0 = Tree(tree_list=['AND',
                         ...
                         ['INF', Tree.tree_list_SUM(2), Tree.tree_list_SUM(2)]],
                name='T0',
                switches=[V0, 1,
                          V1, 2,
                          V2, 2,
    ...
    level = Maze(start_room_index=0,
                 ...
                 fastest_solution="S1 S2 S3 S7 D0 S9 D8 S12 D4 S8 D2 S10 D2 D3 S11 D3 D4 D9",
...
def get_color():
    lcolor = Levels_colors_list.FROM_HUE(hu=0.16, sa=0.3, li=0.5)
    lcolor.contour_color = Color.color_hls(hu=0.3, sa=0.7, li=0.7)
    lcolor.surrounding_color = Color.color_hls(hu=0.3, sa=0.7, li=0.7)
    return lcolor